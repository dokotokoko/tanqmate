...
ユーザーの抽象的な質問に対して、その意図をより具体的に理解するため、3つの簡潔な追加質問と、クリック可能な選択肢を生成してください。
...
{{
  ...
  "clarification_questions": [
    ...
    {{
      "question": "質問2の文章",
      "options": ["選択肢2-1", "選択肢2-2", "選択肢2-3", "選択肢2-4"]
    }},
    {{
      "question": "質問3の文章",
...
quick_optionsは、ユーザーが詳しく答えたくない場合にワンクリックで進められる選択肢です。
